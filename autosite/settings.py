"""
Django settings for autosite project.
...
SECRET_KEY = 'django-insecure-%oyn$x#+6@yvya3rd_d)p1)%6m4q4_8vqt*3q0#vf7=0x^t_q*'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'car_service/static'),
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'car_service/media')
